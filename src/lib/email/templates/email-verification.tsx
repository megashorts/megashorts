...
export const EmailVerificationTemplate = ({ code }: EmailVerificationTemplateProps) => {
  return (
    <Html>
      <Head />
      <Preview>Verify your email address to complete your MEGASHORTS registration</Preview>
      <Body style={main}>
        <Container style={container}>
          <Section>
            <Text style={title}>MEGASHORTS</Text>
            <Text style={text}>Hi,</Text>
            <Text style={text}>
              Thank you for registering for an account on MEGASHORTS. To complete your
