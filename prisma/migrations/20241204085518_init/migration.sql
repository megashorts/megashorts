...
-- CreateEnum
CREATE TYPE "CategoryType" AS ENUM ('COMIC', 'ROMANCE', 'ACTION', 'THRILLER', 'DRAMA', 'PERIOD', 'FANTASY', 'HIGHTEEN', 'ADULT', 'NOTIFICATION', 'MSPOST');
...
CREATE TABLE "users" (
    ...
    "kakaoId" TEXT,
    "naverId" TEXT,
    "myLanguage" TEXT NOT NULL DEFAULT 'ko',
...
CREATE TABLE "posts" (
    ...
    "adultpost" BOOLEAN NOT NULL DEFAULT false,
...
-- AddForeignKey
ALTER TABLE "video_view_aggregates" ADD CONSTRAINT "video_view_aggregates_videoId_fkey" FOREIGN KEY ("videoId") REFERENCES "videos"("id") ON DELETE CASCADE ON UPDATE CASCADE;
